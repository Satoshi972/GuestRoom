 ...
 */
class house extends \houseBundle\Entity\house implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'id', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'name', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'type', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'description', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'address', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'city', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'zipCode', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'start', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'end', '' . "\0" . 'houseBundle\\Entity\\house' . "\0" . 'quota'];
        }
